...
var FederatedReject = function (_Component) {
  _inherits(FederatedReject, _Component);

  function FederatedReject(props) {
    _classCallCheck(this, FederatedReject);

    var _this = _possibleConstructorReturn(this, (FederatedReject.__proto__ || Object.getPrototypeOf(FederatedReject)).call(this, props));
  ...
  return FederatedReject;
}(_react.Component);

exports.default = FederatedReject;