...
var FlightFloatReject = function (_Component) {
  _inherits(FlightFloatReject, _Component);

  function FlightFloatReject(props) {
    _classCallCheck(this, FlightFloatReject);

    var _this = _possibleConstructorReturn(this, (FlightFloatReject.__proto__ || Object.getPrototypeOf(FlightFloatReject)).call(this, props));
    ...
    _this.handleSaveRejectTableRowColumnValue = _this.handleSaveRejectTableRowColumnValue.bind(_this);
    return _this;
  }

  _createClass(FlightFloatReject, [{
    ...
    key: 'handleSaveRejectTableRowColumnValue',
    value: function handleSaveRejectTableRowColumnValue(rowIdx, propertyName, newValue) {
    ...
    value: function render() {
      ...
      var handleClickSubCategoryCell = this.handleClickSubCategoryCell,
          ...
          handleSaveRejectTableRowColumnValue = this.handleSaveRejectTableRowColumnValue;
  ...
  return FlightFloatReject;
}(_react.Component);

exports.default = FlightFloatReject;