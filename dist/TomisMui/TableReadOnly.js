...
var TableReadOnly = function (_React$Component) {
  _inherits(TableReadOnly, _React$Component);

  function TableReadOnly(props) {
    _classCallCheck(this, TableReadOnly);

    var _this = _possibleConstructorReturn(this, (TableReadOnly.__proto__ || Object.getPrototypeOf(TableReadOnly)).call(this, props));
