  ...
  function DatePicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DatePicker.__proto__ || Object.getPrototypeOf(DatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.props.onChange) {
        ...
        _this.handleChangeFromDialog(date);
      }
    ...
    }, _this.handleChangeTextField = function (event, value) {
      _this.setState({ formattedDate: event.target.value });
    }, _this.handleChangeFromDialog = function (value) {
      var momentDate = (0, _moment2.default)(value, MOMENT_FORMAT);
      var jsDate = momentDate.toDate();
      if (momentDate.isValid()) {
        var formattedDate = momentDate.format(MOMENT_FORMAT);
        _this.setState({ date: jsDate, formattedDate: formattedDate, errorText: '' });
      }
    }, _this.handleBlur = function () {
      var formattedDate = _this.state.formattedDate;

      if ((0, _trim3.default)(formattedDate).length === 0) {
        _this.setState({ errorText: '' });
      } else {
        var momentDate = (0, _moment2.default)(formattedDate, MOMENT_FORMAT);
        if (momentDate.isValid()) {
          _this.handleChangeFromDialog(formattedDate);
        } else {
          _this.setState({ errorText: 'Invalid Date' });
        }
      }
  ...
  _createClass(DatePicker, [{
    ...
    value: function componentWillMount() {
      this.setState({
        ...
        formattedDate: this.getControlledDate() ? (0, _moment2.default)(this.getControlledDate()).format(MOMENT_FORMAT) : ''
      });
    }
  }, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.isControlled()) {
        ...
        if (!(0, _dateUtils.isEqualDate)(this.state.date, newDate)) {
          this.setState({
            date: newDate,
            formattedDate: newDate ? (0, _moment2.default)(newDate).format(MOMENT_FORMAT) : ''
          });
        }
      }
    }
    ...
    value: function render() {
      var handleChangeTextField = this.handleChangeTextField,
          handleBlur = this.handleBlur,
          handleAccept = this.handleAccept,
          handleTouchTap = this.handleTouchTap;
      var _state = this.state,
          formattedDate = _state.formattedDate,
          dialogDate = _state.dialogDate,
      ...
      var styleWidth = fullWidth ? '100%' : 'inherit';
      var iconStyleBottom = (0, _trim3.default)(errorText).length > 0 ? '30px' : '0';

      return _react2.default.createElement(
        'div',
        { className: className, style: prepareStyles(Object.assign({}, style, { position: 'relative', width: styleWidth })) },
        ...
        _react2.default.createElement(
          ...
          { onTouchTap: handleTouchTap, className: 'inline-icon', style: { position: 'absolute', right: 0, bottom: iconStyleBottom } },
          _react2.default.createElement(_eventNote2.default, null)
        )
      );
    }
  }]);
