...
var ToggleButtonGroup = function (_Component) {
    _inherits(ToggleButtonGroup, _Component);
    ...
    function ToggleButtonGroup() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ToggleButtonGroup.__proto__ || Object.getPrototypeOf(ToggleButtonGroup)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    _createClass(ToggleButtonGroup, [{
        ...
        value: function render() {
            ...
            var options = _react2.default.Children.map(this.props.children, function (option) {
                ...
                return _react2.default.createElement(_ToggleButton2.default, _extends({}, other, {
...
ToggleButtonGroup.contextTypes = {
