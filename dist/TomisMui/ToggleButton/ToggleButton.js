...
var ToggleButton = function (_Component) {
    ...
    function ToggleButton() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ToggleButton.__proto__ || Object.getPrototypeOf(ToggleButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleSwitch = function (event) {
    ...
    _createClass(ToggleButton, [{
        ...
        value: function render() {
            ...
            var uncheckedElement = _react2.default.createElement(_RaisedButton2.default, { label: label, buttonStyle: buttonStyles, backgroundColor: uncheckedBackgroundColor, labelColor: uncheckedLabelColor, disabled: disabled, style: uncheckedStyles });
            var checkedElement = _react2.default.createElement(_RaisedButton2.default, { label: label, buttonStyle: buttonStyles, backgroundColor: checkedBackgroundColor, labelColor: uncheckedLabelColor, disabled: disabled, style: checkedStyles });
