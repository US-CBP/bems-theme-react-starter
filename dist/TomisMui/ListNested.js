...
var ListsNested = function (_React$Component) {
  _inherits(ListsNested, _React$Component);

  function ListsNested() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, ListsNested);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ListsNested.__proto__ || Object.getPrototypeOf(ListsNested)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      open: false
