...
var AutoCompleteTableRowColumn = function (_Component) {
  _inherits(AutoCompleteTableRowColumn, _Component);

  function AutoCompleteTableRowColumn(props) {
    _classCallCheck(this, AutoCompleteTableRowColumn);

    var _this = _possibleConstructorReturn(this, (AutoCompleteTableRowColumn.__proto__ || Object.getPrototypeOf(AutoCompleteTableRowColumn)).call(this, props));
  ...
  _createClass(AutoCompleteTableRowColumn, [{
    ...
    value: function handleOnChangeValue(newValue) {
