...
class ConsolidatedReject extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const {
      addCaseInformationRow,
      addNoLaunchReasonRow,
      delCaseInformationRow,
      delNoLaunchReasonRow,
      handleSaveCaseInformationTableRowColumnValue,
      handleSaveTableRowColumnValue
    } = this;
...
export default ConsolidatedReject;
