...
class TomisSelectTableRowColumn extends Component {
  constructor(props) {
    super(props);
    const { rowIdx } = props;
...
TomisSelectTableRowColumn.defaultProps = defaultProps;
TomisSelectTableRowColumn.propTypes = propTypes;
export default TomisSelectTableRowColumn;
